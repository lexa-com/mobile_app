    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(this, new OnInitializationCompleteListener() {
            ...
            public void onInitializationComplete(InitializationStatus initializationStatus) {
                Toast.makeText(DailyHistoryActivity.this, " Daily Tips loading ... ", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        live.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(DailyHistoryActivity.this, DailyActivity.class);
                startActivity(i);
            }
        });
        past.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(DailyHistoryActivity.this, DailyHistoryActivity.class);
                startActivity(i);
            }
        });
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        if (!queryDocumentSnapshots.isEmpty()) {
                            ...
                            Toast.makeText(DailyHistoryActivity.this, "No data found in Database", Toast.LENGTH_SHORT).show();
                        }
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(DailyHistoryActivity.this, "Fail to get the data.", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        if (mInterstitialAd != null) {
            mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                ...
                public void onAdDismissedFullScreenContent() {
                    ...
                    mInterstitialAd = null;
                    Intent i = new Intent(DailyHistoryActivity.this, MainActivity.class);
                    startActivity(i);
                }
...
public void onBackPressed() {
     ...
     if (mInterstitialAd != null) {
         mInterstitialAd.show(DailyHistoryActivity.this);
//         Intent i = new Intent(DailyHistoryActivity.this, MainActivity.class);
//         startActivity(i);
     } else {
         Intent i = new Intent(DailyHistoryActivity.this, MainActivity.class);
